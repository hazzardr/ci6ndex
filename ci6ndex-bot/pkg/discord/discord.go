...
var (
	Ci6ndexCommand = &discordgo.ApplicationCommand{
		Name:        "ci6ndex",
		Description: "Provides information about the ci6ndex-bot",
	}
)
...
func (bot *Bot) Start() error {
	...
	slog.Info("ci6ndex-bot initialized and ready to receive events")
	<-stop
	slog.Info("received interrupt signal, shutting down")
	return nil
}

// RegisterSlashCommands attaches all slash commands to the ci6ndex-bot. Database has to be initialized first.
...
func basicCommand(s *discordgo.Session, i *discordgo.InteractionCreate) {
	...
	err := s.InteractionRespond(i.Interaction, &discordgo.InteractionResponse{
		...
		Data: &discordgo.InteractionResponseData{
			Content: "Ci6ndex (Civ VI Index) is a ci6ndex-bot for managing civ 6 draft and game information.",
